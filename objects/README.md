...
![A image](https://ggeis.static.observableusercontent.com/files/fff95ea3e214155b9b2dab3914b585993c145801898e7d48476e5bd9ef6474645178b293c9d17c6a834815829cc739b523b1adb46dfdc6e5798fff863fd4f017?Expires=1632225600000&Key-Pair-Id=APKAJCHFJLLLU4Y2WVSQ&Signature=jACe1yS79wv5iL3t7KRCIsWz38ntfFPYVTQioYWWbLzGuGEpncx12g1pWJGjoYYFwvmi4HGnVmZw2M1PRq9rkP1IuMEd7Zso~okyTJ9yOileQLTfyrk3A9iIRlvhYq-2CWLI5J1JwtFhGJAx1O3Npj3hNDh95A~7V7MOM9rgFrJITdrkPs4KTXK5JXA4~MpqJaKKS50wWzIAkhBVZPjccSUiP4G5f4sxTuFVBx-exoXTUhBHoSCT92oMxqQ5cQH5BdrxDM691ibuSDT-nptnY2vN1zehzU9W50VGuWb9dIkh7fMYBdhC9Z4e5Nk1dq3gJeHgTXL4qem4y76SyVuX0w__)
...
## Mixins
The idea behind mixins, for composing or assembling objects, is different from the approaches we've seen so far. With prototypes, we share state and behavior using chains of links of single objects, but with mixins, we are going to copy pieces of multiple independent objects that together will represent the entirety of the new object’s API. Mixins by themselves don't provide much value on their own, but they are used to compose the business objects. Object composition promotes creating *has-a* or *uses-a* rather than *is-a* relationships among objects. So instead of implicitly delegating to an object’s parent, we completely circumvent inheritance and copy all the properties we need from different sources and directly to the target object.
```typescript
function() {
